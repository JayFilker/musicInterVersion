...
export const radioList = atom<Array<any>>(['https://lzjmusicresource.oss-cn-guangzhou.aliyuncs.com/001.mp3'])
export const radioListDemo = atom<string>('https://lzjmusicresource.oss-cn-guangzhou.aliyuncs.com/001.mp3')
